...
0.09078 (up to Minion 9.07/100+C<minor>)
...
=head2 <backend name: Pg|SQLite|...> => <url string> | <backend object> | <coderef>

If config parameter B<backend name> is a B<coderef> then returned value

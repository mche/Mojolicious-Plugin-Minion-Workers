...
0.9095 (up to Minion version/10+C<child minor>)
...
Tested manual on standard shell commands (on Linux) with L<Minion::Backend::Pg>:
...
B<NOTE>. With L<Minion::Backend::SQLite> Minion workers starting but jobs does not execute.
